  ...
  return (
    <header className="container mx-auto px-4 py-6 xl:px-0 flex justify-between items-center">
      ...
      <ul className="flex justify-between items-center">
        <li className="mr-4 hover:text-alizarin"><a href="https://res.cloudinary.com/soumyanil/image/upload/v1689257652/Resume-Soumyanil-Das.pdf" download>Resume</a></li>
