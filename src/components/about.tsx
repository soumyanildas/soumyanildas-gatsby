    ...
    <section className="about selection:bg-cyan-700 selection:text-white">
      <div className="container mx-auto px-4 py-20 lg:grid-cols-12 lg:gap-x-12 xl:py-40 grid xl:px-0 ">
        ...
        <div className="col-span-12 xl:col-span-6">
          <p className="tracking-tight leading-relaxed text-lg">I am <span className="text-cyan-700 font-semibold">Soumyanil Das</span>, a Calcutta based Front-end Developer who combines code with creative, interactive, and modern designs. As a freelancer, I work across the full JavaScript stack, delivering comprehensive solutions. I am also a Subject Matter Expert - Frontend <span className="text-cyan-700 font-semibold"><a rel="nofollow" href="https://www.cbnits.com/" target="_blank">@CBNITS</a></span>. In my free time, you can catch me gaming on the PS4 or relaxing to music on Spotify.</p>
        </div>
