    ...
    <section className="hero selection:bg-cyan-700 selection:text-white">
      <div className="container mx-auto px-4 lg:gap-8 xl:gap-0 xl:px-0 lg:py-16 lg:flex lg:justify-between lg:items-center">
        <div className="mt-16 text-center lg:text-left">
          ...
          <p className="max-w-3xl font-light text-xl lg:text-3xl tracking-tight">A <span className="text-cyan-700 font-semibold">Calcutta</span> based Software Engineer, Front-end Developer and Air Guitarist</p>
        </div>
