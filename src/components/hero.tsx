  ...
  return (
    <div className="container mx-auto px-4 lg:gap-8 xl:gap-0 xl:px-0 lg:py-16 lg:flex lg:justify-between lg:items-center">
      <div className="mt-16 text-center lg:text-left">
        {welcomeMessage ? <h3 className="max-w-3xl font-extrabold mb-4 text-6xl lg:text-6xl tracking-tight">{welcomeMessage}, I'm <span className="text-alizarin">Soumyanil Das</span></h3> : null}
